...
export default class JackupElement {
  ...
  remove () {
    const html = document.querySelector('html')
    const body = document.querySelector('body')
    if (this.originalHTMLHeightValue) html.style.height = this.originalHTMLHeightValue
    if (this.originalBodyHeightValue) body.style.height = this.originalBodyHeightValue
